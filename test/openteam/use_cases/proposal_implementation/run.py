...
from .orchestrator import install_sigint_handler, Orchestrator
...
async def _main_async() -> None:
    ...
    if args.runtime_base_dir:
        ...
        try:
            ...
            project_root = resolve_project_root(
                ...
                runtime_root_override=Path(args.runtime_root)
            ...
            logging.getLogger(__name__).warning(
                "Could not resolve project_root (%s); falling back to <module>/_runtime/.",
                e,
            )
    ...
    if not args.no_runtime_logs:
        try:
            ...
            logging.getLogger(__name__).warning(
                "Failed to create runtime workspace (%s); continuing without per-call logs.",
                e,
            )
