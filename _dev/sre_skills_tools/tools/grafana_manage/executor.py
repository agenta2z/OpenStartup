...
async def execute(
    ...
    endpoint = arguments.get("endpoint") or os.environ.get(
    ...
    async with aiohttp.ClientSession() as session:
        ...
        if action == "dashboard_get":
            ...
            if not uid:
                return {
                    "status": "error",
                    "message": "Parameter 'uid' is required for dashboard_get.",
                }
            return await _request(
                session, "GET", f"{base_url}/api/dashboards/uid/{uid}", headers
            )
            ...
            return await _request(
                session, "GET", f"{base_url}/api/search", headers, params=params
            )
            ...
            if not dashboard_json:
                return {
                    "status": "error",
                    "message": "Parameter 'dashboard_json' is required.",
                }
            body = (
            ...
            return await _request(
                session, "DELETE", f"{base_url}/api/dashboards/uid/{uid}", headers
            )
            ...
            if not uid:
                return {"status": "error", "message": "Parameter 'uid' is required."}
            return await _request(
                session, "GET", f"{base_url}/api/dashboards/uid/{uid}/versions", headers
            )

        elif action == "dashboard_tags":
            return await _request(
                session, "GET", f"{base_url}/api/dashboards/tags", headers
            )
        ...
        # ==================== ANNOTATION OPERATIONS ====================
            ...
            if arguments.get("limit"):
                params["limit"] = str(arguments["limit"])
            return await _request(
                session, "GET", f"{base_url}/api/annotations", headers, params=params
            )
            ...
            return await _request(
                session, "POST", f"{base_url}/api/annotations", headers, json_data=body
            )
            ...
            if not ann_id:
                return {
                    "status": "error",
                    "message": "Parameter 'annotation_id' is required.",
                }
            body = {}
            if arguments.get("text"):
                body["text"] = arguments["text"]
            ...
            return await _request(
                session,
                "PATCH",
                f"{base_url}/api/annotations/{ann_id}",
                headers,
                json_data=body,
            )
            ...
            return await _request(
                session, "DELETE", f"{base_url}/api/annotations/{ann_id}", headers
            )
        ...
        # ==================== ALERT RULE OPERATIONS ====================
            ...
            return await _request(
                session, "GET", f"{base_url}/api/v1/provisioning/alert-rules", headers
            )
            ...
            if not rule_json:
                return {
                    "status": "error",
                    "message": "Parameter 'alert_rule_json' is required.",
                }
            ...
            if not uid or not rule_json:
                return {
                    "status": "error",
                    "message": "Parameters 'uid' and 'alert_rule_json' are required.",
                }
            body = json.loads(rule_json) if isinstance(rule_json, str) else rule_json
        ...
        # ==================== ALERTMANAGER OPERATIONS ====================
            ...
            return await _request(
                session,
                "GET",
                f"{base_url}/api/alertmanager/grafana/api/v2/alerts/groups",
                headers,
            )
        ...
        # ==================== FOLDER OPERATIONS ====================
            ...
            if not uid:
                return {"status": "error", "message": "Parameter 'uid' is required."}
            return await _request(
                session, "GET", f"{base_url}/api/folders/{uid}", headers
            )
            ...
            return await _request(
                session, "POST", f"{base_url}/api/folders", headers, json_data=body
            )
            ...
            if arguments.get("overwrite"):
                body["overwrite"] = True
            return await _request(
                session, "PUT", f"{base_url}/api/folders/{uid}", headers, json_data=body
            )
            ...
            if not uid:
                return {"status": "error", "message": "Parameter 'uid' is required."}
            return await _request(
                session, "DELETE", f"{base_url}/api/folders/{uid}", headers
            )
        ...
        # ==================== DATA SOURCE OPERATIONS ====================
            ...
            return await _request(
                session, "GET", f"{base_url}/api/datasources", headers
            )
            ...
            if not ds_uid:
                return {
                    "status": "error",
                    "message": "Parameter 'datasource_uid' or 'uid' is required.",
                }
            return await _request(
                session, "GET", f"{base_url}/api/datasources/uid/{ds_uid}", headers
            )
            ...
            if not ds_uid or not query:
                return {
                    "status": "error",
                    "message": "Parameters 'datasource_uid' and 'query' are required.",
                }
            params = {"query": query}
            if arguments.get("from"):
