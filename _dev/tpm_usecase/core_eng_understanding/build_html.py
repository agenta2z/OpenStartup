...
DOCS = [
    ...
    (
        "03_platform_pillars_brie_tsp_tdp_encryption_alp_sandbox.md",
        "Platform Pillars: BRIE · TSP · TDP · Encryption · ALP · Sandbox",
    ),
    (
        "04_compliance_scale_finops_engexcellence_new_ent.md",
        "Compliance · Scale · FinOps · Eng Excellence · New ENT Requests",
    ),
...
def build():
    ...
    for filename, section_title in DOCS:
        ...
        sidebar_links += (
            f'    <a class="section-link" href="#{section_id}">{section_title}</a>\n'
        )
