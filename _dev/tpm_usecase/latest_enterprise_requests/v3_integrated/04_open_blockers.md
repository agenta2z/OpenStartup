# 04 · Open Blocker / Critical — what's hot right now
*(verified 2026-05-15)*
...
>
> This is the canonical "right now" list. Earlier docs in this folder labelled many *Minor* tickets as "P0 / blocker"; this file contains only items where Jira's `priority` field is **Blocker** or **Critical** (verified live).

## The 21 items

| # | Key | Priority | Component | Pillar | DRI / Owner | Summary |
|---|---|---|---|---|---|---|
| 1 | [ENT-3881](https://hello.atlassian.net/browse/ENT-3881) | Blocker | Rovo / AI - Other | AI ↔ Identity (Trust) | Ashwini Rattihalli (assignee), Dushyant Gill (Trust scope) | DocuSign — Rovo HIPAA blocking AI adoption (customer evaluating Glean) — **status: Roadmap (Internal Only)** |
...
| 16 | [ENT-381](https://hello.atlassian.net/browse/ENT-381) | Blocker | Atlas / Project | (Atlas — outside CoreEng) | Atlas team | Easy way to target teams that will / are contributing to a feature |
...
|---|---|---|
| **Identity** (incl. ALP, Trust, FedRAMP) | 8 | Single largest absorber — owns audit logs, FedRAMP, IL5 / IL6, Private Cloud Trust scope |
| **TDP** (Encryption / BYOK) | 4 | Pure BYOK family + adjacent CMK |
...
## Suggested triage actions (TPM perspective)
...
6. **ENT-376, ENT-381 (Atlas Blockers)** — flag to Atlas team via cross-org escalation; not CoreEng's to deliver but visible on the same JQL.
