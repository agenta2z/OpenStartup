...
``web-gui`` is the **UI** package responsible for delivering
...
* **Application developers** integrating ``web-gui`` into a workflow.
...
* Programmatic API exposed by the ``web_gui`` Python module.
