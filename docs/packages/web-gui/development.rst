...
.. code-block:: bash
    ...
    pip install -e 'packages/web-gui[dev]'
...
.. code-block:: bash
    ...
    pytest packages/web-gui/tests -q
...
.. code-block:: bash
    ...
    ruff check packages/web-gui
    mypy packages/web-gui/src
...
``docs/_build/html/packages/web-gui/index.html``.
