...
``mcp-scout`` is the **INTEGRATION (MCP)** package responsible for delivering
...
* **Application developers** integrating ``mcp-scout`` into a workflow.
...
* Programmatic API exposed by the ``mcp_scout`` Python module.
