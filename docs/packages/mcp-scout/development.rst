...
.. code-block:: bash
    ...
    pip install -e 'packages/mcp-scout[dev]'
...
.. code-block:: bash
    ...
    pytest packages/mcp-scout/tests -q
...
.. code-block:: bash
    ...
    ruff check packages/mcp-scout
    mypy packages/mcp-scout/src
...
``docs/_build/html/packages/mcp-scout/index.html``.
