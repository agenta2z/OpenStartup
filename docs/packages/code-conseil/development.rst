...
.. code-block:: bash
    ...
    pip install -e 'packages/code-conseil[dev]'
...
.. code-block:: bash
    ...
    pytest packages/code-conseil/tests -q
...
.. code-block:: bash
    ...
    ruff check packages/code-conseil
    mypy packages/code-conseil/src
...
``docs/_build/html/packages/code-conseil/index.html``.
