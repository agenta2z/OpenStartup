...
``code-nemo`` is the **FEATURE** package responsible for delivering
...
* **Application developers** integrating ``code-nemo`` into a workflow.
...
* Programmatic API exposed by the ``code_nemo`` Python module.
