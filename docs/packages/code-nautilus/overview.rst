...
``code-nautilus`` is the **FEATURE** package responsible for delivering
...
* **Application developers** integrating ``code-nautilus`` into a workflow.
...
* Programmatic API exposed by the ``code_nautilus`` Python module.
